                                ...
                                <div class="block block-rounded">
                                    <div class="block-header block-header-default">
                                        ...
                                        <div class="block-options">
                                            <a href="{{ route('downloadpdf') }}" class="fw-bold">
                                            ...
                                            <tbody>
                                                @foreach ($user as $usr)
                                                    <tr>
                                                        <td class="d-none d-sm-table-cell">
                                                            @if ($usr->image != null)
                                                                <img class="img-avatar img-avatar48"
                                                                    src="assets/media/avatars/{{ $usr->image }}"
                                                                    alt="">
                                                            @else
                                                                <img class="img-avatar img-avatar48"
                                                        ...
                                                        <td class="fw-semibold text-break">{{ $usr->name }}</td>
                                                        <td class="text-break">{{ $usr->email }}</td>
                                                        <td>
                                                            <div class="btn-group">
                                                                <a href="{{ route('edit', ['id' => $usr->id]) }}">
                                                                    <button type="button"
                            ...
                            <div class="col-md-6 mt-5">
                                <div class="block block-themed block-rounded">
                                    <div class="block-header bg-primary-light">
                                        <h3 class="block-title">No user</h3>
                                    </div>
                                    <div class="block-content">
                                        <p>Currently there is no users</p>
                                    </div>
                                </div>
                            </div>
                        @endif
