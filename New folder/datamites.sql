...
CREATE TABLE `states` (
  ...
  `country_id` varchar(211) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `users` (
  ...
  `type` int(11) DEFAULT NULL COMMENT '99=admin',
...
INSERT INTO `users` (`id`, `image`, `name`, `mobile`, `email`, `password`, `state`, `city`, `type`, `description`, `created_at`, `updated_at`) VALUES
(2, NULL, 'aditya', '7338334843', 'adi@gmail.com', '7f850f6be05778d824f473d121a9936452a8bd2e', NULL, NULL, 99, NULL, '2023-06-10 14:22:00', '2023-06-10 14:22:00'),
(5, NULL, 'sourabh', '7338334843', 'sarkarsourabh1223334@gmail.com', '45cc7371c0a99adf514b448b0267302c308fd944', '35', '4', 0, NULL, '2023-06-11 04:37:56', '2023-06-11 04:37:56'),
(6, '1686480479.jpg', 'Raghavendra rao', '774411223355', 'rao@gmail.com', 'f670cb32c1544d0058ec248370042bcbb547ffa7', '1', '13', 0, NULL, '2023-06-11 05:17:59', '2023-06-11 05:17:59');
